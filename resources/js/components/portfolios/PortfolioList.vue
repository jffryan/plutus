...
<template>
  <div class="p-6 max-w-3xl mx-auto">
    ...
    <!-- New Portfolio Form -->
     <button v-if="!isFormToggled" @click="toggleForm" class=" text-left font-semibold space-y-3 bg-gray-100 p-4 rounded w-full mb-6">
    ...
    <div v-if="portfolios.length" class="space-y-4">
      <SimplePortfolioTile v-for="p in portfolios" :key="p.id" :portfolio="p" />
    </div>
